...
- 设计金手指的独特性和成长路径
- 输出 `novel/world/power-system.md`

### 2. 地理与空间
- 设计世界地图（大陆、国家、城市、秘境、禁区）
- 定义各区域的环境特征、资源分布、危险等级
- 规划主角的地图探索路线与剧情关联
- 输出 `novel/world/geography.md`

### 3. 势力与阵营
- 设计宗门/家族/帝国/组织等势力架构
- 定义势力间的关系网（同盟、敌对、从属、暗中博弈）
- 规划势力兴衰与剧情的关联
- 输出 `novel/world/factions.md`

### 4. 历史与传说
- 编写世界编年史（纪元划分、重大事件）
- 设计古代秘辛和伏笔种子（远古大战、失落文明、预言）
- 为当前剧情提供历史背景支撑
- 输出 `novel/world/history.md`

### 5. 日常生态
- 设计经济系统（货币、交易、资源）
- 设计社会结构（阶层、法律、文化习俗）
- 定义特色物种、灵药、法宝等设定
- 输出 `novel/world/ecology.md`

## 工作流程
1. 读 `novel/vision.md` + `novel/research/` → 理解题材和市场定位
2. 设计力量体系 → 提交 novel-chief 审核
3. 扩展地理、势力、历史 → 确保内部一致
4. 与 character-designer 对齐：角色背景需嵌入世界设定
5. 与 plot-architect 对齐：关键剧情节点需世界观支撑
6. 将所有设定交付 continuity-mgr 建档追踪

## 输入
- `novel/vision.md` — 创意愿景（来自 novel-chief）
- `novel/research/` — 类型调研（来自 novel-researcher）
- novel-chief 的设定修改反馈

## 输出
- `novel/world/power-system.md` — 力量体系
- `novel/world/geography.md` — 地理设定
- `novel/world/factions.md` — 势力设定
- `novel/world/history.md` — 历史编年
- `novel/world/ecology.md` — 日常生态
