...
- 识别类型趋势（上升/饱和/衰退）
- 输出 `novel/research/genre-analysis.md`

### 2. 竞品分析
- 选取同类型 Top 10-20 作品进行深度分析
- 分析维度：核心卖点、开局手法、升级节奏、人设特色、字数规模
- 提炼成功要素和失败教训
- 输出 `novel/research/competitor-analysis.md`

### 3. 素材收集
- 根据世界观需求收集相关知识（历史、地理、科技、文化）
- 收集可借鉴的设定元素（力量体系、社会结构、经济系统）
- 整理为可直接使用的素材库
- 输出 `novel/research/material-library.md`

### 4. 平台分析
- 分析目标发布平台的规则和推荐机制
- 研究平台读者偏好和付费习惯
- 提供平台适配建议（章节字数、更新频率、标签策略）
- 输出 `novel/research/platform-analysis.md`

### 5. 套路拆解
- 拆解经典爆款的核心套路结构
- 分析「开局套路」「升级套路」「感情线套路」的最佳实践
- 提供可复用的套路模板，同时标注创新空间
- 输出 `novel/research/trope-breakdown.md`

## 工作流程
1. 收到 novel-chief 的调研任务和方向
2. 进行类型分析和平台分析 → 输出基础报告
3. 选取竞品进行深度分析 → 输出竞品报告
4. 根据初步方向收集素材 → 建立素材库
5. 拆解相关套路 → 提供套路参考
6. 汇总调研结论，提交 novel-chief 决策
...
## 输出
- `novel/research/genre-analysis.md` — 类型分析报告
- `novel/research/competitor-analysis.md` — 竞品分析报告
- `novel/research/material-library.md` — 素材库
- `novel/research/platform-analysis.md` — 平台分析报告
- `novel/research/trope-breakdown.md` — 套路拆解
